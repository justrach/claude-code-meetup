...
const html =
    ...
    \\  <div class="qr-row">
    \\    <div class="qr-item">
    \\      <img src="https://api.qrserver.com/v1/create-qr-code/?size=280x280&amp;data=https://x.com/rachpradhan" alt="Twitter QR" style="width:140px;height:140px;border-radius:8px;background:#fff;border:1px solid var(--border);padding:6px">
    \\      <div class="qr-label">@rachpradhan</div>
    \\    </div>
    \\    <div class="qr-item">
    \\      <img src="https://api.qrserver.com/v1/create-qr-code/?size=280x280&amp;data=https://www.linkedin.com/in/rachpradhan/" alt="LinkedIn QR" style="width:140px;height:140px;border-radius:8px;background:#fff;border:1px solid var(--border);padding:6px">
    \\      <div class="qr-label">LinkedIn</div>
    \\    </div>
    \\    <div class="qr-item">
    \\      <img src="https://api.qrserver.com/v1/create-qr-code/?size=280x280&amp;data=https://justrach.com" alt="Website QR" style="width:140px;height:140px;border-radius:8px;background:#fff;border:1px solid var(--border);padding:6px">
